...
public class CashFlowMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        CashFlow cf1 = new CashFlow(date( "2013-01-12"), 100, "CREDIT", 1 );
        CashFlow cf2 = new CashFlow(date( "2013-02-2"), 200, "DEBIT", 1 );
        CashFlow cf3 = new CashFlow(date( "2013-05-18"), 50, "CREDIT", 1 );
        CashFlow cf4 = new CashFlow(date( "2013-03-07"), 75, "CREDIT", 1 );
        ...
        Collection<? extends Object> objects = ksession.getObjects(new ClassObjectFilter(Account.class));

        Account account = (Account) objects.iterator().next();
